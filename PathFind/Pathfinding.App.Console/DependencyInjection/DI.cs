...
namespace Pathfinding.App.Console.DependencyInjection
{
    ...
    internal static class DI
    {
        ...
        private static IContainer Configure()
        {
            ...
            builder.RegisterType<ChangeCostMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<AssembleGraphMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<ResizeGraphMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<EnterCostRangeMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<EnterGraphAssembleMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<EnterGraphParametresMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<EnterObstaclePercentMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<LoadGraphMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<SaveGraphMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<ReverseVertexMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
            builder.RegisterType<SmoothGraphMenuItem>().Keyed<IMenuItem>(typeof(GraphUnit)).SingleInstance().AutoActivate();
