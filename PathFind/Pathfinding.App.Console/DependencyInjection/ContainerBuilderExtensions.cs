...
namespace Pathfinding.App.Console.DependencyInjection
{
    ...
    internal static class ContainerBuilderExtensions
    {
        ...
        public static ContainerBuilder AddGraphEditor(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddColorsEditor(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddTransitVertices(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddAlgorithms(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddPathfindingVisualization(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddPathfindingHistory(this ContainerBuilder builder)
        {
        ...
        public static ContainerBuilder AddPathfindingControl(this ContainerBuilder builder)
        {
        ...
        public static IContainer BuildApplication(this ContainerBuilder builder)
        {
            ...
            builder.RegisterType<VertexVisualizations>().CommunicateContainers().SingleInstance().AsImplementedInterfaces()
                .ConfigurePipeline(p => p.Use(new VerticesVisualizationMiddleware(VisualizedTypeKey)));
