...
namespace Pathfinding.ConsoleApp.View.ButtonsFrameViews
{
    ...
    {
        private readonly DeleteGraphButtonModel viewModel;
        private readonly CompositeDisposable disposables = new CompositeDisposable();

        public DeleteGraphButton(DeleteGraphButtonModel viewModel)
        {
            this.viewModel = viewModel;
            Initialize();
            this.Events().MouseClick.Where(x => x.MouseEvent.Flags == MouseFlags.Button1Clicked)
