...
{
    internal sealed class CreateDepthRandomAlgorithmRunViewModel : CreateRunButtonViewModel
    {
        public CreateDepthRandomAlgorithmRunViewModel(IRequestService<VertexModel> service,
