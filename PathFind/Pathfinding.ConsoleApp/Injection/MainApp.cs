...
namespace Pathfinding.ConsoleApp.Injection
{
    internal static class MainApp
    {
        ...
        private static IContainer BuildApp(this ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CreationFormErrorsView>().Keyed<Terminal.Gui.View>(KeyFilters.CreateGraphView).WithAttributeFiltering();
            ...
            builder.RegisterType<RequestService<VertexViewModel>>()
                .As<IRequestService<VertexViewModel>>().SingleInstance();
            ...
            builder.RegisterType<CreateGraphViewModel>().AsSelf().WithAttributeFiltering();
            ...
            builder.RegisterType<CreationFormErrorsViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
            builder.RegisterType<GraphParametresViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
            builder.RegisterType<NeighborhoodFactoryViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
            builder.RegisterType<SmoothLevelsViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
            builder.RegisterType<GraphTableViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
            builder.RegisterType<GraphNameViewModel>().AsSelf().SingleInstance().WithAttributeFiltering();
